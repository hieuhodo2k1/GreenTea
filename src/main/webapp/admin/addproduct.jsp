		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<c:if test="${isOK==true}">
						<div class="alert alert-success" role="alert">Thêm sản phẩm
							thành công</div>
					</c:if>
					...
					<form action="add-product" enctype="multipart/form-data"
						method="post">
						<input type="hidden" name="isSubmit" value="true"></input>
							...
							<div class="col-8">
								<div class="mb-3">
									<label for="name" class="form-label">Tên sản phẩm</label> <input
										type="text" class="form-control" required="required" id="name"
										name="name-product" placeholder="Nhập tên sản phẩm">
								</div>
								<div class="mb-3">
									<label for="des" class="form-label">Mô tả</label>
									<textarea class="form-control" required="required" id="des"
										name="des-product" rows="3"></textarea>
								</div>
								<div class="mb-3">
							...
							<div class="col-4">
								<div class="mb-3">
									<label for="formFile" class="form-label">Ảnh đại diện</label> <input
										class="form-control" required="required" name="file"
										type="file" id="formFile" accept="image/*"
										onchange="loadFile(0,event)"> <img alt="" src=""
										class="preview-image" style="width: 100%">

								</div>
								<div class="row">
									<div class="col">
										<div class="mb-3">
											<label for="formFile1" class="form-label">Ảnh bổ sung
												1</label> <input class="form-control" required="required"
												name="file" type="file" id="formFile1" accept="image/*"
												onchange="loadFile(1,event)"> <img alt="" src=""
												class="preview-image" style="width: 100%">
										</div>
									</div>
									<div class="col">
										<div class="mb-3">
											<label for="formFile2" class="form-label">Ảnh bỏ sung
												2</label> <input class="form-control" required="required"
												name="file" type="file" id="formFile2" accept="image/*"
												onchange="loadFile(2,event)"> <img alt="" src=""
												class="preview-image" style="width: 100%">
										</div>
									</div>
								</div>
